...
def check_collision(snake):
    x,y=snake.coordinates[0]
    if x<0 or x>= cfg.GAME_WIDTH:
        return True
    elif y<0 or y>=cfg.GAME_HEIGHT:
        print("GAME OVER")
        return True
...
def game_over():
    canvas.delete(ALL)
    canvas.create_text(canvas.winfo_width()/2,canvas.winfo_height()/2, font=('consolas',70),text="GAME OVER",fill="purple")
